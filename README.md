...
| **Возраст вместо диапазона** | [`shared/validation.py`](shared/validation.py) → `party_bands` | Спрашивался «сколько детей 2–11» и отдельно «сколько до 2» — два ответа могли противоречить друг другу, а менеджер всё равно переспрашивала возраст. Теперь возрасты вводятся списком, а полосы тарифов выводятся из них: 14 лет уходит во взрослые, потому что авиакомпания посчитает именно так |
