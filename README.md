...
| В обычном Telegram-диалоге бюджет **на человека**, а Telegram/VK Mini App — **на всю поездку**; `price_max` у Tutu за оффер целиком | Для Telegram умножаем на число пассажиров, для VK передаём общий бюджет без повторного умножения |
