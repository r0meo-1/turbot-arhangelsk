...
| В обычном Telegram-диалоге бюджет **на человека**, а Telegram/VK Mini App — **на всю поездку**; `price_max` у Tutu за оффер целиком | Для обычного Telegram-диалога умножаем на число пассажиров; для Mini App передаём общий бюджет без повторного умножения |
