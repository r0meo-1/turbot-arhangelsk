...
# Текст уходит живым людям от имени агентства, поэтому здесь нет ни английских
# вставок, ни согласований наугад. «Всё включённое на любом вкус» — так было —
# читается как машинный перевод и обесценивает всё сообщение целиком.
TEMPLATE_INTROS: Dict[str, str] = {
    "египет": (
        "Древние пирамиды, кристально чистое Красное море и отели «всё включено» "
        "на любой вкус."
    ),
    "турция": (
        "Пляжный отдых, богатая история и гостеприимная кухня — "
        "с системой «всё включено» на побережье."
    ),
    "таиланд": (
        "Экзотическая природа, белоснежные пляжи, буддийские храмы "
        "и доступный комфортный отдых для всей семьи."
    ),
    "мальдивы": (
        "Райские острова с бирюзовой лагуной, бунгало над водой "
        "и идеальной атмосферой для двоих."
    ),
    "оаэ": (
        "Современный комфорт, роскошные отели, шопинг и пляжи с тёплым морем — "
        "и всё это без оформления визы."
    ),
}
